namespace LightAT3
{
    unsafe public sealed partial class Decoder
    {
        static uint MAPCDSF_getHuffValue(DecoderSearchTableDes huff_table, BitReader mbr0)//ushort *table0, byte *table1, uint max_len,  MaiBitReader mbr0)
        {
        ...
        static int MAPCDSF_readPackTable0(BitReader mbr0, DecoderPackTable0 table, uint counter)
        {
        ...
        static int MAPCDSF_decodeTable0DataNum(BitReader mbr0, DecoderChnInfo chn_info)
        {
        ...
        static int MAPCDSF_padTable0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            if (chn_info.table0_flag_data_num == 0)
            {
            }
        ...
        static int MAPCDSF_exTable0Value(DecoderChnInfo chn_info)
        {
        ...
        static int MAPCDSF_makeTable0CheckTable(DecoderChnInfo chn_info, uint[] check_table)
        {
            if (0 == chn_info.chn_flag)
            {
        ...
        static int MAPCDSF_decodeTable0_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            for (uint a0 = 0; a0 < chn_info.joint_chn_info.num_band_splited_declared; a0++)
            {
        ...
        static int MAPCDSF_decodeTable0_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeTable0_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.table0_data_num0 != 0)
            {
                ...
                var huff_table_now = Decoder_StaticData.MAPCDSD_huff_table0[uk1c6e0];
        ...
        static int MAPCDSF_decodeTable0_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.table0_data_num0 > 0)
            {
                ...
                {
                    chn_info.table0[a0] = chn_info.table0[a0 - 1] + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table0[huff_table_type0], mbr0);
                    chn_info.table0[a0] &= 0x7;
                }
            }
        ...
        static int MAPCDSF_decodeTable0_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.table0_data_num0 > 0)
            {
                ...
                for (uint a0 = 0; a0 < chn_info.table0_data_num0; a0++)
                {
                    chn_info.table0[a0] = chn_info.chn_ref.table0[a0] + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table0[huff_table_type1], mbr0);
                    chn_info.table0[a0] &= 0x7;
                }
            }
        ...
        static int MAPCDSF_decodeTable0_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.table0_data_num0 != 0)
            {
                ...
                DecoderSearchTableDes huff_table_now = Decoder_StaticData.MAPCDSD_huff_table0[uk1c6e0];
        ...
        delegate int DecoderSubFuncType0(BitReader mbr0, DecoderChnInfo chn_info);

        static readonly DecoderSubFuncType0[] MAPCDSF_decodeTable0_func_list0 = {
        ...
        static int MAPCDSF_initTable1(DecoderChnInfo chn_info)
        {
        ...
        static int MAPCDSF_decodeTable1_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeTable1_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeTable1_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.joint_chn_info.num_band_splited_used != 0)
            {
                DecoderSearchTableDes huff_table_now = Decoder_StaticData.MAPCDSD_huff_table1_2[uk1c70c];
                for (uint a0 = 0; a0 < chn_info.joint_chn_info.num_band_splited_used; a0++)
                {
        ...
        static int MAPCDSF_decodeTable1_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (tmp3 == 3)
            {
                ...
                DecoderSearchTableDes huff_table_now = Decoder_StaticData.MAPCDSD_huff_table1_2[huff_table_type2];
            ...
            else
            {
                ...
                for (uint a0 = 1; a0 < chn_info.joint_chn_info.num_band_splited_used; a0++)
                {
                    chn_info.table1[a0] = chn_info.table1[a0 - 1] + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table1[huff_table_type2], mbr0);
                    chn_info.table1[a0] &= 0x3F;
                }
        ...
        static int MAPCDSF_decodeTable1_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < chn_info.joint_chn_info.num_band_splited_used; a0++)
            {
                chn_info.table1[a0] = MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table1[huff_table_type3], mbr0);
        ...
        static int MAPCDSF_decodeTable1_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;

            uint huff_table_type3 = (uint)mbr0.getWithI32Buffer(2);

            chn_info.table1[0] = chn_info.chn_ref.table1[0] + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table1[huff_table_type3], mbr0);
        ...
        static int MAPCDSF_decodeTable1_Route6(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeTable1_func_list0 =
        {
        ...
        static int MAPCDSF_decodeTable2_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeTable2_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < read_counter; a0++)
            {
                if (chn_info.check_table0[a0] == 1) chn_info.table2[a0] = MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table2[chn_info.joint_chn_info.var90], mbr0); //tmp4
                else if (chn_info.check_table0[a0] == 0) chn_info.table2[a0] = 0;
                else if (chn_info.check_table0[a0] == 2) chn_info.table2[a0] = (uint)mbr0.getWithI32Buffer(1);
                else
                {
        ...
        static int MAPCDSF_decodeTable2_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            DecoderSearchTableDes huff_table_now0;
            DecoderSearchTableDes huff_table_now1;

            if (0 == chn_info.joint_chn_info.var90)
            {
                huff_table_now0 = Decoder_StaticData.MAPCDSD_huff_table2[0];
                huff_table_now1 = Decoder_StaticData.MAPCDSD_huff_table2[0];
            }
            else
            {
                huff_table_now0 = Decoder_StaticData.MAPCDSD_huff_table2[1];
                huff_table_now1 = Decoder_StaticData.MAPCDSD_huff_table2[2];
            }
        ...
        static int MAPCDSF_decodeTable2_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeTable2_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < read_counter; a0++)
            {
                if (chn_info.check_table0[a0] == 1)
                {
                    chn_info.table2[a0] = MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table2_2[chn_info.joint_chn_info.var90], mbr0); //tmp4
                    chn_info.table2[a0] += chn_info.chn_ref.table2[a0];
                    chn_info.table2[a0] &= Decoder_StaticData.MAPCDSD_huff_table2_2[chn_info.joint_chn_info.var90].mask;
                }
                else if (chn_info.check_table0[a0] == 0) chn_info.table2[a0] = 0;
                else if (chn_info.check_table0[a0] == 2) chn_info.table2[a0] = (uint)mbr0.getWithI32Buffer(1);
                else
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeTable2_func_list0 =
        {
        ...
        static int MAPCDSF_decodeTable3Sub0(BitReader mbr0, ManagedPointer<short> buf_to_read, uint num_to_read, DecoderSearchTableDes huff_table_now)
        {
            int rs = 0;
                    ...
                    for (uint b1 = 0; b1 < huff_table_now.uk2; b1++)
                    {
                        ...
                        if (0 == huff_table_now.uk5)
                        {
                            if ((value_now & (1 << (huff_table_now.uk6 - 1))) != 0)
                                buf_to_read[tcounter0++] = (short)((ushort)value_now | (~((1 << (huff_table_now.uk6)) - 1)));
                            else
        ...
        static int MAPCDSF_decodeACC2Main0_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main0_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;

            for (uint a0 = 0; a0 < chn_info.uk1b450; a0++)
            {
                chn_info.acc_data_now.table[a0].num_acc = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_0[0], mbr0);
            }
        ...
        static int MAPCDSF_decodeACC2Main0_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;

            chn_info.acc_data_now.table[0].num_acc = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_0[0], mbr0);

            for (uint a0 = 1; a0 < chn_info.uk1b450; a0++)
            {
                chn_info.acc_data_now.table[a0].num_acc = (int)(chn_info.acc_data_now.table[a0 - 1].num_acc + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_1[0], mbr0));
        ...
        static int MAPCDSF_decodeACC2Main0_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main0_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < chn_info.uk1b450; a0++)
            {
                chn_info.acc_data_now.table[a0].num_acc = (int)(
                    ...
                    + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_1[0], mbr0)
                );
        ...
        static int MAPCDSF_decodeACC2Main0_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeACC2Main_func_list0 =
        {
        ...
        static int MAPCDSF_decodeACC2MainSub0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main1_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main1_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < chn_info.uk1b450; a0++)
            {
                ...
                {
                    chn_info.acc_data_now.table[a0].data1[0] = MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_2[0], mbr0);

                    for (uint a1 = 1; a1 < (uint)chn_info.acc_data_now.table[a0].num_acc; a1++)
                    {
                        chn_info.acc_data_now.table[a0].data1[a1] =
                            chn_info.acc_data_now.table[a0].data1[a1 - 1]
                            + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_3[0], mbr0);
        ...
        static int MAPCDSF_decodeACC2Main1_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;

            if (chn_info.acc_data_now.table[0].num_acc != 0)
            {
                chn_info.acc_data_now.table[0].data1[0] = MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_2[0], mbr0);
                ...
                for (uint a1 = 0; a1 < (uint)chn_info.acc_data_now.table[a0].num_acc; a1++)
                {
                    if (a1 < (uint)chn_info.acc_data_now.table[a0 - 1].num_acc)
                    {
                        chn_info.acc_data_now.table[a0].data1[a1] =
                            ...
                            + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_4[0], mbr0);
        ...
        static int MAPCDSF_decodeACC2Main1_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main1_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
                ...
                for (uint a1 = 0; a1 < (uint)chn_info.acc_data_now.table[a0].num_acc; a1++)
                {
                    if (a1 < (uint)chn_info.chn_ref.acc_data_now.table[a0].num_acc)
                    {
                        chn_info.acc_data_now.table[a0].data1[a1] =
                            ...
                            + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_5[0], mbr0);
        ...
        static int MAPCDSF_decodeACC2Main1_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main1_Route6(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeACC2Main_func_list1 =
        {
        ...
        //used in decodeACC2Main
        static int MAPCDSF_decodeACC2MainSub1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_parseACCDataMemberUsingBitRead(uint a0, uint a1, BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main2_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_parseACCDataMemberUsingHuffTable0(uint a0, BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.acc_data_now.table[a0].num_acc != 0)
            {
                ...
                for (uint a1 = 1; a1 < (uint)chn_info.acc_data_now.table[a0].num_acc; a1++)
                {
                    DecoderSearchTableDes huff_table_now = null;

                    if (((int)chn_info.acc_data_now.table[a0].data1[a1])
                        - ((int)chn_info.acc_data_now.table[a0].data1[a1 - 1])
                        <= 0)
                    {
                        huff_table_now = Decoder_StaticData.MAPCDSD_huff_table_global_6[0];
                    }
                    else
                    {
                        huff_table_now = Decoder_StaticData.MAPCDSD_huff_table_global_7[0];
                    }
        ...
        static int MAPCDSF_decodeACC2Main2_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_parseACCDataMemberUsingHuffTable1(uint a0, BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.acc_data_now.table[a0].num_acc != 0)
            {
                if (chn_info.acc_data_now.table[a0 - 1].num_acc != 0)
                {
                    chn_info.acc_data_now.table[a0].data0[0] = (int)(
                        ...
                        + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_8[0], mbr0)
                    );
                ...
                {
                    chn_info.acc_data_now.table[a0].data0[0] =
                        (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_8[0], mbr0);
                }
                ...
                for (uint a1 = 1; a1 < (uint)chn_info.acc_data_now.table[a0].num_acc; a1++)
                {
                        ...
                        <= 0)
                    {
                        ...
                        {
                            huff_table_now = Decoder_StaticData.MAPCDSD_huff_table_global_8[0];
                        }
                    }
                    else
                    {
                        ...
                        {
                            huff_table_now = Decoder_StaticData.MAPCDSD_huff_table_global_9[0];
                        }
                    }
        ...
        static int MAPCDSF_decodeACC2Main2_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main2_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_parseACCDataMemberUsingHuffTable2(uint a0, BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.acc_data_now.table[a0].num_acc != 0)
            {
                if (chn_info.chn_ref.acc_data_now.table[a0].num_acc != 0)
                {
                    chn_info.acc_data_now.table[a0].data0[0] = (int)(
                        ...
                        + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_10[0], mbr0)
                    );
                ...
                for (uint a1 = 1; a1 < (uint)chn_info.acc_data_now.table[a0].num_acc; a1++)
                {
                        ...
                        <= 0)
                    {
                        ...
                        {
                            huff_table_now = Decoder_StaticData.MAPCDSD_huff_table_global_10[0];
                        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            chn_info.acc_data_now.table[a0].data0[a1] = (int)(
                                chn_info.acc_data_now.table[a0].data0[a1 - 1]
                                + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_7[0], mbr0)
                            );
                        }
                    }
                }
        ...
        static int MAPCDSF_decodeACC2Main2_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main2_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main2_Route6(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeACC2Main_func_list2 =
        {
        ...
        //used in decodeACC2Main
        static int MAPCDSF_decodeACC2MainSub2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_makeInnerPackTable0CheckTable(DecoderChnInfo chn_info, int arg2)
        {
            ...
            DecoderChnACCTable acc_table_to_use = (arg2 != 0) ? chn_info.acc_table_now : chn_info.acc_table_old;
        ...
        static int MAPCDSF_decodeACC6Inner0_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC6Inner0_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeACC6InnerSub0_func_list0 =
        {
        ...
        //used in MAPCDSF_decodeACC6InnerSub0 0
        static int MAPCDSF_decodeACC6Inner1_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        //used in MAPCDSF_decodeACC6InnerSub0 1
        static int MAPCDSF_decodeACC6Inner1_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
            {
                if (chn_info.inner_pack_table0_check_table[a0] != 0)
                {
                    chn_info.acc_table_now.table[a0].num_uk = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_12[0], mbr0);
                }
            }
        ...
        static int MAPCDSF_decodeACC6Inner1_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
            {
                if (chn_info.inner_pack_table0_check_table[a0] != 0)
                {
                    int atmp0 = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_13[0], mbr0);
        ...
        static int MAPCDSF_decodeACC6Inner1_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_decodeACC6InnerSub0_func_list1 =
        {
        ...
        static int MAPCDSF_splitePack0_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_splitePack0_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
            {
                if (chn_info.inner_pack_table0_check_table[a0] != 0)
                {
                    ...
                    {
                        int atmp0 = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_14[0], mbr0);
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_splitePack_func_list0 =
        {
        ...
        static int MAPCDSF_makeTable11C(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_splitePack1_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (0 == chn_info.acc_table_now.inner.unk1)
            {
                for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
                {
                    if (chn_info.inner_pack_table0_check_table[a0] != 0)
                    {
                        if (chn_info.acc_table_now.table[a0].num_uk != 0)
                        {
                            chn_info.acc_table_now.table[a0].ptr0[0].unk0 = (int)(0x18 + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_15[0], mbr0));
            ...
            else
            {
                for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
                {
                    if (chn_info.inner_pack_table0_check_table[a0] != 0)
                    {
                        for (int a1 = 0; a1 < chn_info.acc_table_now.table[a0].num_uk; a1++)
                        {
                            chn_info.acc_table_now.table[a0].ptr0[a1].unk0 = (int)(0x14 + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_16[0], mbr0));
                        }
                    }
                }
            }
        ...
        static int MAPCDSF_splitePack1_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (0 == chn_info.acc_table_now.inner.unk1)
            {
                for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
                {
                    if (chn_info.inner_pack_table0_check_table[a0] != 0)
                    {
                        if (chn_info.acc_table_now.table[a0].num_uk > 0)
                        {
                            int atmp0 = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_17[0], mbr0);
        ...
        static int MAPCDSF_splitePack1_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_splitePack_func_list1 =
        {
        ...
        static int MAPCDSF_splitePack2_Route0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_splitePack2_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
            {
                if (chn_info.inner_pack_table0_check_table[a0] != 0)
                {
                    ...
                    {
                        chn_info.acc_table_now.table[a0].ptr0[0].unk1 = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_18[0], mbr0);
                    }
                    else
                    {
                        for (int a1 = 0; a1 < chn_info.acc_table_now.table[a0].num_uk; a1++)
                        {
                            chn_info.acc_table_now.table[a0].ptr0[a1].unk1 = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_19[0], mbr0);
                        }
                    }
                }
            }
        ...
        static int MAPCDSF_splitePack2_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.acc_table_now.inner.unk2; a0++)
            {
                if (chn_info.inner_pack_table0_check_table[a0] != 0)
                {
                    for (int a1 = 0; a1 < chn_info.acc_table_now.table[a0].num_uk; a1++)
                    {
                        int atmp0 = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_20[0], mbr0);
        ...
        static readonly DecoderSubFuncType0[] MAPCDSF_splitePack_func_list2 =
        {
        ...
        static int MAPCDSF_readSplitePackMemberNum(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_splitePack(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC6InnerSub0(BitReader mbr0, DecoderChnInfo chn_info)
        {
            int rs = 0;
