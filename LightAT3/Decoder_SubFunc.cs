...
namespace LightAT3
{
    public sealed unsafe partial class Decoder
    {
                ...
                for (uint a0 = 1; a0 < chn_info.Table0DataNum0; a0++)
                {
                    chn_info.Table0[a0] = chn_info.Table0[a0 - 1] +
                                          MAPCDSF_getHuffValue(
                                              Decoder_StaticData.MAPCDSD_huff_table0[huff_table_type0],
                                              mbr0);
                    chn_info.Table0[a0] &= 0x7;
                }
            }
            ...
            if (chn_info.Table0DataNum0 > 0)
            {
                ...
                for (uint a0 = 0; a0 < chn_info.Table0DataNum0; a0++)
                {
                    chn_info.Table0[a0] = chn_info.ChnRef.Table0[a0] +
                                          MAPCDSF_getHuffValue(
                                              Decoder_StaticData.MAPCDSD_huff_table0[huff_table_type1],
                                              mbr0);
                    chn_info.Table0[a0] &= 0x7;
                }
            }
        ...
        static int MAPCDSF_decodeTable0_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            if (chn_info.Table0DataNum0 != 0)
            {
                ...
                DecoderSearchTableDes huff_table_now =
                    Decoder_StaticData.MAPCDSD_huff_table0[uk1c6e0];
        ...
        delegate int MaiAT3PlusCoreDecoderSubFuncType0(BitReader mbr0, DecoderChnInfo chn_info);
        ...
        static int MAPCDSF_decodeTable1_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            {
                DecoderSearchTableDes huff_table_now =
                    Decoder_StaticData.MAPCDSD_huff_table1_2[uk1c70c];
                for (uint a0 = 0; a0 < chn_info.JointChnInfo.NumBandSplitedUsed; a0++)
                {
        ...
        static int MAPCDSF_decodeTable1_Route3(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            if (tmp3 == 3)
            {
                ...
                DecoderSearchTableDes huff_table_now =
                    Decoder_StaticData.MAPCDSD_huff_table1_2[huff_table_type2];
            ...
            else
            {
                ...
                for (uint a0 = 1; a0 < chn_info.JointChnInfo.NumBandSplitedUsed; a0++)
                {
                    chn_info.Table1[a0] = chn_info.Table1[a0 - 1] +
                                          MAPCDSF_getHuffValue(
                                              Decoder_StaticData.MAPCDSD_huff_table1[huff_table_type2],
                                              mbr0);
                    chn_info.Table1[a0] &= 0x3F;
                }
        ...
        static int MAPCDSF_decodeTable1_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            {
                chn_info.Table1[a0] =
                    MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table1[huff_table_type3], mbr0);
        ...
        static int MAPCDSF_decodeTable1_Route5(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            chn_info.Table1[0] = chn_info.ChnRef.Table1[0] +
                                 MAPCDSF_getHuffValue(
                                     Decoder_StaticData.MAPCDSD_huff_table1[huff_table_type3], mbr0);
        ...
        static int MAPCDSF_decodeTable2_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            for (uint a0 = 0; a0 < read_counter; a0++)
            {
                if (chn_info.CheckTable0[a0] == 1)
                    chn_info.Table2[a0] =
                        MAPCDSF_getHuffValue(
                            Decoder_StaticData.MAPCDSD_huff_table2[chn_info.JointChnInfo.Var90],
                            mbr0); //tmp4
                else if (chn_info.CheckTable0[a0] == 0) chn_info.Table2[a0] = 0;
                else if (chn_info.CheckTable0[a0] == 2) chn_info.Table2[a0] = (uint)mbr0.GetWithI32Buffer(1);
                else
        ...
        static int MAPCDSF_decodeTable2_Route4(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            for (uint a0 = 0; a0 < read_counter; a0++)
            {
                if (chn_info.CheckTable0[a0] == 1)
                {
                    chn_info.Table2[a0] =
                        MAPCDSF_getHuffValue(
                            Decoder_StaticData.MAPCDSD_huff_table2_2[chn_info.JointChnInfo.Var90],
                            mbr0); //tmp4
                    chn_info.Table2[a0] += chn_info.ChnRef.Table2[a0];
                    chn_info.Table2[a0] &= Decoder_StaticData
        ...
        static int MAPCDSF_decodeTable3Sub0(BitReader mbr0, ManagedPointer<short> buf_to_read, uint num_to_read,
            DecoderSearchTableDes huff_table_now)
        {
            int rs = 0;
        ...
        static int MAPCDSF_decodeACC2Main0_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            for (uint a0 = 0; a0 < chn_info.Uk1B450; a0++)
            {
                chn_info.AccDataNow.Table[a0].NumAcc =
                    (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_0[0], mbr0);
            }
            ...
            for (uint a0 = 0; a0 < chn_info.Uk1B450; a0++)
            {
                if (chn_info.AccDataNow.Table[a0].NumAcc != 0)
                {
                    chn_info.AccDataNow.Table[a0].Data1[0] =
                        MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_2[0], mbr0);

                    for (uint a1 = 1; a1 < (uint)chn_info.AccDataNow.Table[a0].NumAcc; a1++)
                    {
                        chn_info.AccDataNow.Table[a0].Data1[a1] =
                            chn_info.AccDataNow.Table[a0].Data1[a1 - 1]
                            + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_3[0],
                                mbr0);
                ...
                for (uint a1 = 0; a1 < (uint)chn_info.AccDataNow.Table[a0].NumAcc; a1++)
                {
                    if (a1 < (uint)chn_info.AccDataNow.Table[a0 - 1].NumAcc)
                    {
                        chn_info.AccDataNow.Table[a0].Data1[a1] =
                            ...
                            + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_4[0],
                                mbr0);
                ...
                for (uint a1 = 0; a1 < (uint)chn_info.AccDataNow.Table[a0].NumAcc; a1++)
                {
                    if (a1 < (uint)chn_info.ChnRef.AccDataNow.Table[a0].NumAcc)
                    {
                        chn_info.AccDataNow.Table[a0].Data1[a1] =
                            ...
                            + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_5[0],
                                mbr0);
        ...
        static int MAPCDSF_parseACCDataMemberUsingBitRead(uint a0, uint a1, BitReader mbr0,
            DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_parseACCDataMemberUsingHuffTable0(uint a0, BitReader mbr0,
            DecoderChnInfo chn_info)
        {
            int rs = 0;
        ...
        static int MAPCDSF_parseACCDataMemberUsingHuffTable1(uint a0, BitReader mbr0,
            DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.AccDataNow.Table[a0].NumAcc != 0)
            {
                ...
                {
                    chn_info.AccDataNow.Table[a0].Data0[0] =
                        (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_8[0],
                            mbr0);
                }
        ...
        static int MAPCDSF_parseACCDataMemberUsingHuffTable2(uint a0, BitReader mbr0,
            DecoderChnInfo chn_info)
        {
            int rs = 0;
            ...
            if (chn_info.AccDataNow.Table[a0].NumAcc != 0)
            {
                ...
                {
                    chn_info.AccDataNow.Table[a0].Data0[0] = (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_10[0], mbr0);
                }
                ...
                for (uint a1 = 1; a1 < (uint)chn_info.AccDataNow.Table[a0].NumAcc; a1++)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            chn_info.AccDataNow.Table[a0].Data0[a1] = (int)(
                                chn_info.AccDataNow.Table[a0].Data0[a1 - 1]
                                + MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_7[0],
                                    mbr0)
                            );
                        }
                    }
        ...
        static int MAPCDSF_makeInnerPackTable0CheckTable(DecoderChnInfo chn_info, int arg2)
        {
            ...
            DecoderChnAccTable acc_table_to_use =
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.AccTableNow.Inner.Unk2; a0++)
            {
                if (chn_info.InnerPackTable0CheckTable[a0] != 0)
                {
                    chn_info.AccTableNow.Table[a0].NumUk =
                        (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_12[0],
                            mbr0);
                }
            }
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.AccTableNow.Inner.Unk2; a0++)
            {
                if (chn_info.InnerPackTable0CheckTable[a0] != 0)
                {
                    int atmp0 = (int)MAPCDSF_getHuffValue(
                        Decoder_StaticData.MAPCDSD_huff_table_global_13[0], mbr0);
        ...
        static int MAPCDSF_splitePack0_Route1(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.AccTableNow.Inner.Unk2; a0++)
            {
                if (chn_info.InnerPackTable0CheckTable[a0] != 0)
                {
                    ...
                    {
                        int atmp0 = (int)MAPCDSF_getHuffValue(
                            Decoder_StaticData.MAPCDSD_huff_table_global_14[0], mbr0);
                        ...
                        if (chn_info.AccTableNow.Table[a0].NumUk != 0)
                        {
                            chn_info.AccTableNow.Table[a0].Ptr0[0].Unk0 =
                                (int)(0x18 + MAPCDSF_getHuffValue(
                                           Decoder_StaticData.MAPCDSD_huff_table_global_15[0], mbr0));
                        ...
                        for (int a1 = 0; a1 < chn_info.AccTableNow.Table[a0].NumUk; a1++)
                        {
                            chn_info.AccTableNow.Table[a0].Ptr0[a1].Unk0 =
                                (int)(0x14 + MAPCDSF_getHuffValue(
                                           Decoder_StaticData.MAPCDSD_huff_table_global_16[0], mbr0));
                        }
                    }
                }
            }
            ...
            if (0 == chn_info.AccTableNow.Inner.Unk1)
            {
                for (uint a0 = 0; a0 < (uint)chn_info.AccTableNow.Inner.Unk2; a0++)
                {
                    if (chn_info.InnerPackTable0CheckTable[a0] != 0)
                    {
                        ...
                        {
                            int atmp0 = (int)MAPCDSF_getHuffValue(
                                Decoder_StaticData.MAPCDSD_huff_table_global_17[0], mbr0);
                ...
                if (chn_info.InnerPackTable0CheckTable[a0] != 0)
                {
                    if (chn_info.AccTableNow.Table[a0].NumUk == 1)
                    {
                        chn_info.AccTableNow.Table[a0].Ptr0[0].Unk1 =
                            (int)MAPCDSF_getHuffValue(Decoder_StaticData.MAPCDSD_huff_table_global_18[0],
                                mbr0);
                    }
                    else
                    {
                        for (int a1 = 0; a1 < chn_info.AccTableNow.Table[a0].NumUk; a1++)
                        {
                            chn_info.AccTableNow.Table[a0].Ptr0[a1].Unk1 =
                                (int)MAPCDSF_getHuffValue(
                                    Decoder_StaticData.MAPCDSD_huff_table_global_19[0], mbr0);
                        }
                    }
                }
            }
        ...
        static int MAPCDSF_splitePack2_Route2(BitReader mbr0, DecoderChnInfo chn_info)
        {
            ...
            for (uint a0 = 0; a0 < (uint)chn_info.AccTableNow.Inner.Unk2; a0++)
            {
                if (chn_info.InnerPackTable0CheckTable[a0] != 0)
                {
                    ...
                    {
                        int atmp0 = (int)MAPCDSF_getHuffValue(
                            Decoder_StaticData.MAPCDSD_huff_table_global_20[0], mbr0);
