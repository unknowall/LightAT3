...
namespace LightAT3
{
    public sealed class DecoderChnAccDataEntry
    {
        public int NumAcc;
    ...
    {
        public DecoderChnAccDataEntry[] Table = CreateTable();
        public DecoderPackTable0 Acc = new DecoderPackTable0();

        public static DecoderChnAccDataEntry[] CreateTable()
        {
            return Enumerable.Range(0, 0x10).Select(index => new DecoderChnAccDataEntry()).ToArray();
        }
    ...
    public sealed unsafe class DecoderChnAccTableTable
    {
    ...
    public sealed class DecoderChnAccTable
    {
        ...
        public static DecoderChnAccTableTable[] CreateTable()
        {
    ...
    public sealed unsafe class DecoderChnInfo
    {
        public int ChnFlag;
        public DecoderJointChnInfo JointChnInfo = new DecoderJointChnInfo();
        public DecoderChnAccData AccDataNow = new DecoderChnAccData();
        public DecoderChnAccData AccDataOld = new DecoderChnAccData();
        public DecoderChnAccTable AccTableOld = new DecoderChnAccTable();
        public DecoderChnAccTable AccTableNow = new DecoderChnAccTable();
        public DecoderChnInfo ChnRef;
    ...
    public sealed class DecoderChnAccTableInner
    {
        ...
        public ManagedPointer<DecoderChnAccTableData> PtrToUseNow;
        public DecoderPackTable0 TableUnk0;
        public DecoderPackTable0 TableUnk1;
        public DecoderPackTable0 TableUnk2;
    }
    ...
    {
        DecoderChnInfo[] _chnInfo = new DecoderChnInfo[2];
        ...
        public Decoder()
        {
            DecoderJointChnInfo jointChnInfo = new DecoderJointChnInfo();
            ...
            {
                _chnInfo[a0] = new DecoderChnInfo();

                _chnInfo[a0].ChnFlag = a0;
                _chnInfo[a0].JointChnInfo = jointChnInfo;

                _chnInfo[a0].AccDataOld = new DecoderChnAccData();
                _chnInfo[a0].AccDataNow = new DecoderChnAccData();
                _chnInfo[a0].AccTableOld = new DecoderChnAccTable();
                _chnInfo[a0].AccTableOld.Inner = inner0;

                _chnInfo[a0].AccTableNow = new DecoderChnAccTable();
        ...
        public int ParseStream(BitReader mbr0, uint chns, uint jointFlag)
        {
            int rs = 0;
        ...
        int DecodeBandNum(BitReader mbr0, DecoderChnInfo[] chnInfos)
        {
            ...
            chnInfos[0].JointChnInfo.NumBandDeclared =
                (uint)Decoder_StaticData.MAPCDSD_band_num_table0[
        ...
        int DecodeTable0(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;
        ...
        int DecodeTable1(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;
        ...
        int DecodeTable2(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;
        ...
        int DecodeTable3(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < chns; a0++)
            {
                ...
                for (uint a1 = 0; a1 < chnInfos[0].JointChnInfo.NumBandSplitedUsed; a1++)
                {
                    ...
                    {
                        for (uint a2 = 0; a2 < Decoder_StaticData.MAPCDSD_bind_table1[a1]; a2++)
                            chnInfos[a0].Table3[Decoder_StaticData.MAPCDSD_bind_table0[a1] + a2] = 0;
                    }
                    else
                    {
                        uint atmp0 = 0;
                        ...
                        if (0 == chnInfos[a0].JointChnInfo.Var90)
                            atmp0 = Decoder_StaticData.MAPCDSD_bind_table2[
                                (chnInfos[a0].Var1034 * 7 + chnInfos[a0].Table0[a1]) * 4 +
                                chnInfos[a0].Table2[a1]]; //tmp4 5 6
                        else atmp0 = chnInfos[a0].Table2[a1];

                        DecoderSearchTableDes huffTableNow =
                            Decoder_StaticData.MAPCDSD_huff_table3[
                                (chnInfos[a0].Var1034 * 8 + atmp0) * 7 + chnInfos[a0].Table0[a1]]; //tmp5 6

                        MAPCDSF_decodeTable3Sub0(mbr0,
                            chnInfos[a0].Table3
                                .GetPointer((int)Decoder_StaticData.MAPCDSD_bind_table0[a1]),
                            Decoder_StaticData.MAPCDSD_bind_table1[a1], huffTableNow);
                    }
                }
                ...
                {
                    for (uint a1 = 0;
                        a1 < (uint)(Decoder_StaticData.MAPCDSD_band_num_table1[
                                         Decoder_StaticData.MAPCDSD_band_num_table0[
            ...
            if (chns == 2)
            {
                MAPCDSF_readPackTable0(mbr0, chnInfos[0].JointChnInfo.Table48, chnInfos[0].JointChnInfo.NumBandUsed);
                MAPCDSF_readPackTable0(mbr0, chnInfos[0].JointChnInfo.Table00, chnInfos[0].JointChnInfo.NumBandUsed);
            }

            return rs;
        }

        int DecodeAcc2Pre(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;

            for (uint a0 = 0; a0 < chns; a0++)
            {
                MAPCDSF_readPackTable0(mbr0, chnInfos[a0].AccDataNow.Acc, chnInfos[0].JointChnInfo.NumBandDeclared);
            }

            return rs;
        }

        int DecodeAcc2Main(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;
            ...
            for (uint a0 = 0; a0 < chns; a0++)
            {
                ...
                if (uk1B444 != 0)
                {
                    ...
                    if (uk1B448 != 0)
                    {
                        ...
                        {
                            chnInfos[a0].AccDataNow.Table[b0].NumAcc = chnInfos[a0].AccDataNow.Table[b0 - 1].NumAcc;
                            for (uint b1 = 0; b1 < (uint)chnInfos[a0].AccDataNow.Table[b0].NumAcc; b1++)
                            {
                                chnInfos[a0].AccDataNow.Table[b0].Data1[b1] = chnInfos[a0].AccDataNow.Table[b0 - 1].Data1[b1];
                                chnInfos[a0].AccDataNow.Table[b0].Data0[b1] = chnInfos[a0].AccDataNow.Table[b0 - 1].Data0[b1];
                            }
                        }
                    }
                }
        ...
        static int DecodeAcc6Inner(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;

            if (chns == 2)
            {
                chnInfos[0].AccTableNow.Inner.TableUnk0 = new DecoderPackTable0();
                chnInfos[0].AccTableNow.Inner.TableUnk1 = new DecoderPackTable0();
                chnInfos[0].AccTableNow.Inner.TableUnk2 = new DecoderPackTable0();
            }
            ...
            chnInfos[0].AccTableNow.Inner.PtrToUseNow = chnInfos[0].AccTableNow.Inner.Data;

            chnInfos[0].AccTableNow.Inner.Unk0 =  mbr0.GetWithI32Buffer(1);

            if (chnInfos[0].AccTableNow.Inner.Unk0 != 0)
            {
                chnInfos[0].AccTableNow.Inner.Unk1 =  mbr0.GetWithI32Buffer(1);
        ...
        int DecodeTailInfo(BitReader mbr0, DecoderChnInfo[] chnInfos, uint chns)
        {
            int rs = 0;
