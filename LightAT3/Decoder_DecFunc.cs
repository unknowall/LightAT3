namespace LightAT3
{
    unsafe public sealed partial class Decoder
    {
        ...
        private short[] l136_array = new short[0x10];
        private float[] l127_array = new float[0x80];
        private float[] l128_array = new float[0x80];
        private float[] l128_swap_array = new float[0x80];
        private float[] lo256_array = new float[0x100];
        private float[] l256_array = new float[0x100];
        private float[] l512_array = new float[0x100];
        private int[] l63_array = new int[0x40];
        private float[] stmp40_array = new float[0x80];
        private float[][] l2080_array = new float[0x10][];
        private float[] l2048_array = new float[0x800];
        private float[] stmp140_array = new float[0x10];
        private float[] stmp30_array = new float[0x100];
        private float[] locals_array = new float[0x100];
        private float[] calc_buf_array = new float[0x100];
        float[][] syn_buf = { new float[0x1000], new float[0x1000] };
        float[][] dst_buf = { new float[0x800], new float[0x800] };
        private int c900 = 0;

        int MAPCDDF_initMDataTable(DecoderChnInfo[] chn_infos, float** pptablef0, uint chns)
        {
            ...
            fixed (uint* table_search1 = table_search1_o)
            {
                    ...
                    {
                        {
                            ...
                            DecoderChnACCData acc_data1;
                            DecoderChnACCData acc_data2;
                            ...
                            {
                                int arg3_1 = l136_array[a0];
                                for (uint a1 = 0; a1 < 0x80; a1++)
                                {
                                    uint tmp0 = 0x38000000;
                                    l127_array[a1] = Decoder_StaticData.MAPCDSD_table_static_0[arg3_1 & 0x3FF] * (*(float*)&tmp0);
                                    arg3_1++;
                                }
                                ...
                                for (uint a1 = MAPCDDF_initMDataTable_table_tmp5[a0]; a1 < MAPCDDF_initMDataTable_table_tmp6[a0]; a1++)
                                {
                                    if (chn_infos[a00].table0[a1] > 0)
                                    {
                                        ...
                                        for (int a2 = (int)table_search0[a1], a3 = 0;
                                            ...
                                            a2++, a3++)
                                        {
                                            pptablef0[a00][a2] += l129 * l127_array[a3];
                                        }
                                    }
                                }
                            }
                ...
                if (chns == 2)
                {
                    for (uint a0 = 0; a0 < chn_infos[0].joint_chn_info.num_band_used; a0++)
                    {
                        ...
                        {
                            for (uint a1 = 0; a1 < 0x80; a1++) l128_swap_array[a1] = pptablef0[0][a0 * 0x80 + a1];
                            for (uint a1 = 0; a1 < 0x80; a1++) pptablef0[0][a0 * 0x80 + a1] = pptablef0[1][a0 * 0x80 + a1];
                            for (uint a1 = 0; a1 < 0x80; a1++) pptablef0[1][a0 * 0x80 + a1] = l128_swap_array[a1];
                        }
        ...
        static int makeSL128(DecoderChnACCTableTable acc, float* lo, int num0, int num1, int acc_4, int acc_360, int chn)
        {
            ...
            fixed (byte* table_tmp1_o = _makeSL128_table_tmp1_o)
            {
                ...
                if (acc_4 == 0)
                {
                    for (int a0 = 0; a0 < acc.num_uk; a0++)
                    {
                        ...
                        {
                            lo[a1] += l259 * Decoder_StaticData.MAPCDSD_table_static_3[ctmp0];
                            ctmp0 += acc.ptr0[a0].unk3;
                            ctmp0 &= 0x7FF;
                        }
                    }
        ...
        int MAPCDDF_makeL128(DecoderChnACCTableTable acc5, int acc5_4, int acc5_360,
                DecoderChnACCTableTable acc6, int acc6_4, int acc6_360,
                float* l128, int chn)
        {
            int rs = 0;

            var lo256_array = new float[0x100];
            fixed (float* lo256 = lo256_array)
            {
                ...
                if ((acc5.num_uk > 0) && (acc6.num_uk > 0) && (acc5.unk[3] - 0x80 >= acc6.unk[2]))
                {
                    ...
                    {
                        lo128[a0] *= Decoder_StaticData.MAPCDSD_table_static_5[a0];
                        lo256[a0] *= Decoder_StaticData.MAPCDSD_table_static_4[a0];
                    }
                }
                else
                {
        ...
        public int decodeStream(uint chns)
        {
            ...
            float[][] mdata0_table = new float[2][];
            mdata0_table[0] = mdata0_0;
            mdata0_table[1] = mdata0_1;

            fixed (float* mdata0_ptr0 = mdata0_0)
            fixed (float* mdata0_ptr1 = mdata0_1)
            {
                float*[] mdata0_table_ptrs = new float*[2];
                mdata0_table_ptrs[0] = mdata0_ptr0;
                mdata0_table_ptrs[1] = mdata0_ptr1;

                fixed (float** pmdata0_table_ptrs = mdata0_table_ptrs)
                    MAPCDDF_initMDataTable(chn_info, pmdata0_table_ptrs, chns);

                if (true)
                {
                    for (int a00 = 0; a00 < chns; a00++)
                    {
                        for (int a0 = 0; a0 < 0x800; a0++) l2048_array[a0] = 0.0f;

                        for (int a0 = 0; a0 < 0x10; a0++)
                        {
                            for (int a1 = 0; a1 < 0x80; a1++)
                            {
                                l2080_array[a0][a1] = l2048_array[a0 * 0x80 + a1];
                            }
                        }
                            ...
                            for (int a0 = 0; a0 < chn_info[0].joint_chn_info.num_band_declared; a0++)
                            {
                                    ...
                                    == 0)
                                {
                                    if (chn_info[a00].acc_data_now.table[a0].acc_now
                                        == 0)
                                    {
                                        table_shita = Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x000);
                                    }
                                    else
                                    {
                                        table_shita = Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x100);
                                    }
                                }
                                else
                                {
                                    if (chn_info[a00].acc_data_now.table[a0].acc_now
                                        == 0)
                                    {
                                        table_shita = Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x200);
                                    }
                                    else
                                    {
                                        table_shita = Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x300);
                                    }
                                }

                                {
                                    for (uint a1 = 0; a1 < 0x40; a1++)
                                    {
                                        if ((a0 & 1) != 0)
                                        {
                                            stmp40_array[a1 * 2] = mdata0_table[a00][0x80 * a0 + a1 * 2] * Decoder_StaticData.MAPCDSD_table_sin0[a1]
                                                + mdata0_table[a00][0x80 * a0 + 0x80 - a1 * 2 - 1] * Decoder_StaticData.MAPCDSD_table_cos0[a1];
                                            stmp40_array[a1 * 2 + 1] = mdata0_table[a00][0x80 * a0 + 0x80 - a1 * 2 - 1] * Decoder_StaticData.MAPCDSD_table_sin0[a1]
                                                - mdata0_table[a00][0x80 * a0 + a1 * 2] * Decoder_StaticData.MAPCDSD_table_cos0[a1];

                                        }
                                        else
                                        {
                                            stmp40_array[a1 * 2] = mdata0_table[a00][0x80 * a0 + 0x80 - a1 * 2 - 1] * Decoder_StaticData.MAPCDSD_table_sin0[a1]
                                                + mdata0_table[a00][0x80 * a0 + a1 * 2] * Decoder_StaticData.MAPCDSD_table_cos0[a1];
                                            stmp40_array[a1 * 2 + 1] = mdata0_table[a00][0x80 * a0 + a1 * 2] * Decoder_StaticData.MAPCDSD_table_sin0[a1]
                                                - mdata0_table[a00][0x80 * a0 + 0x80 - a1 * 2 - 1] * Decoder_StaticData.MAPCDSD_table_cos0[a1];
                                        }
                                    }
                                    ...
                                    for (uint a2 = 0; a2 < 6; a2++)
                                    {
                                        for (uint a3 = 0; a3 < (1 << (int)a2); a3++)
                                        {
                                            ...
                                            {
                                                float ftmp0 = stmp40_array[base1 + a1 * 2 + 1] + stmp40_array[base1 + a1 * 2 + 1 + base0];
                                                float ftmp1 = stmp40_array[base1 + a1 * 2] - stmp40_array[base1 + a1 * 2 + base0];
                                                float ftmp2 = stmp40_array[base1 + a1 * 2 + 1] - stmp40_array[base1 + a1 * 2 + 1 + base0];
                                                float ftmp3 = stmp40_array[base1 + a1 * 2] + stmp40_array[base1 + a1 * 2 + base0];

                                                stmp40_array[base1 + a1 * 2] = ftmp3;
                                                stmp40_array[base1 + a1 * 2 + 1] = ftmp0;

                                                stmp40_array[base1 + a1 * 2 + base0] = ftmp2 * Decoder_StaticData.MAPCDSD_table_sin1[a2 * 0x20 + a1]
                                                    + ftmp1 * Decoder_StaticData.MAPCDSD_table_cos1[a2 * 0x20 + a1];
                                                stmp40_array[base1 + a1 * 2 + 1 + base0] = ftmp1 * Decoder_StaticData.MAPCDSD_table_sin1[a2 * 0x20 + a1]
                                                    - ftmp2 * Decoder_StaticData.MAPCDSD_table_cos1[a2 * 0x20 + a1];
                                            }
                                        }
                                    }
                                    ...
                                    for (uint a1 = 0; a1 < 0x40; a1++)
                                    {
                                        l512_array[a1] = stmp40_array[search_table_tmp0[a1]] * table_shita[a1];
                                        l512_array[0xC0 + a1] = (-1.0f) * stmp40_array[search_table_tmp1[a1]] * table_shita[0xc0 + a1];
                                    }

                                    for (uint a1 = 0; a1 < 0x80; a1++)
                                    {
                                        l512_array[0x40 + a1] = (-1.0f) * stmp40_array[search_table_tmp2[0x80 - a1 - 1]] * table_shita[0x40 + a1];
                                    }
                                }
                                ...
                                if ((chn_info[a00].acc_data_old.table[a0].num_acc != 0) || (chn_info[a00].acc_data_now.table[a0].num_acc != 0))
                                {
                                    ...
                                    {
                                        for (int a1 = 0; a1 < 0x40; a1++) l63_array[a1] = 0;
                                        ...
                                        for (int a1 = 0; a1 < chn_info[a00].acc_data_now.table[a0].num_acc; a1++)
                                        {
                                                ...
                                                chn_info[a00].acc_data_now.table[a0].data0[a1])
                                            {
                                                for (int a2 = dtmp0; a2 < 0x20 + 0x1 +
                                                    ...
                                                    a2++)
                                                {
                                                    l63_array[dtmp0++] = table_tmp4[chn_info[a00].acc_data_now.table[a0].data1[a1]];
                                                }
                                            }
                                        }
                                        ...
                                        for (int a1 = 0; a1 < chn_info[a00].acc_data_old.table[a0].num_acc; a1++)
                                        {
                                            for (int a2 = atmp5; a2 < 0x1 +
                                                    ...
                                                    a2++)
                                            {
                                                l63_array[atmp5++] += table_tmp4[chn_info[a00].acc_data_old.table[a0].data1[a1]];
                                            }
                                        }

                                        float l64 = 0.0f;
                                        int ctmp1 = 0 - l63_array[0x3F];
                                        if (ctmp1 >= 0)
                                        {
                                            l64 = (float)(1 << ctmp1);
                                        }
                                        ...
                                        {
                                            if (l63_array[a1] == itmp1)
                                            {
                                                l256_array[dtmp1--] = l64;
                                                l256_array[dtmp1--] = l64;
                                                l256_array[dtmp1--] = l64;
                                            }
                                            else
                                            {
                                                ...
                                                if (l63_array[a1] < itmp1)
                                                {
                                                    int ctmp2 = 0 - l63_array[a1];
                                                    int itmp2 = itmp1 - l63_array[a1] - 1;
                                                    ...
                                                    {
                                                        l64 = 1.0f / (1 << l63_array[a1]);
                                                    }

                                                    itmp2 *= 3;

                                                    l256_array[dtmp1--] = l64 * Decoder_StaticData.MAPCDSD_table_static_2[itmp2];
                                                    l256_array[dtmp1--] = l64 * Decoder_StaticData.MAPCDSD_table_static_2[itmp2 + 1];
                                                    l256_array[dtmp1--] = l64 * Decoder_StaticData.MAPCDSD_table_static_2[itmp2 + 2];
                                                }
                                                else
                                                {
                                                    int ctmp2 = 0 - itmp1;
                                                    int btmp_2 = l63_array[a1] - itmp1 - 1;
                                                    ...
                                                    l256_array[dtmp1--] = l64 * Decoder_StaticData.MAPCDSD_table_static_2[btmp_2 + 2];
                                                    l256_array[dtmp1--] = l64 * Decoder_StaticData.MAPCDSD_table_static_2[btmp_2 + 1];
                                                    l256_array[dtmp1--] = l64 * Decoder_StaticData.MAPCDSD_table_static_2[btmp_2];

                                                    ctmp2 = 0 - l63_array[a1];
                                                    if (ctmp2 >= 0)
                                                    {
                                                        l64 = (float)(1 << ctmp2);
                                                    }
                                    ...
                                    {
                                        l512_array[a1] *= l256_array[a1];
                                    }

                                    for (int a1 = 0; a1 < 0x80; a1++)
                                    {
                                        l2080_array[a0][a1] = kyou_buf[a00][a0 * 0x80 + a1] + l512_array[a1] * l256_array[a1];
                                    }
                                }
                                else
                                {
                                    for (int a1 = 0; a1 < 0x80; a1++)
                                    {
                                        l2080_array[a0][a1] = kyou_buf[a00][a0 * 0x80 + a1] + l512_array[a1];
                                    }
                                }

                                for (int a1 = 0; a1 < 0x80; a1++)
                                {
                                    kyou_buf[a00][a0 * 0x80 + a1] = l512_array[0x80 + a1];
                                }
                            }
...

                        {
                            if ((chn_info[a00].acc_table_old.inner.unk0 != 0) || (chn_info[a00].acc_table_now.inner.unk0 != 0))
                            {
                                for (int a0 = 0; a0 < 0x10; a0++)
                                {
                                    ...
                                    {
                                        fixed (float* l128_ptr = l128_array)
                                        {
                                            MAPCDDF_makeL128(
                                        ...
                                        for (int a1 = 0; a1 < 0x80; a1++)
                                        {
                                            l2080_array[a0][a1] += l128_array[a1];
                                        }
                                    }
                                }
                            }
                            ...
                            if (chn_info[0].joint_chn_info.var94 != 0)
                            {
                                ...
                                for (int a0 = 0; a0 < 0x10; a0++)
                                {
                                    for (int a1 = 0; a1 < 0x80; a1++)
                                    {
                                        ...
                                        l2080_array[a0][a1] += Decoder_StaticData.MAPCDSD_table_static_0[index1 + a1] * tmpf0;
                                    }
...

                        {
                            ...
                            for (int a0 = 0; a0 < 0x80; a0++)
                            {
                                ...
                                {
                                    stmp140_array[a1] = l2080_array[a1][a0] * table_626a90[a1];
                                }

                                for (int a1 = 0; a1 < 4; a1++)
                                {
                                    stmp30_array[a1] = stmp140_array[a1] + stmp140_array[0x7 - a1] + stmp140_array[0x8 + a1] + stmp140_array[0xF - a1];
                                }

                                for (int a1 = 0; a1 < 4; a1++)
                                {
                                    stmp30_array[0x4 + a1] = stmp140_array[a1] + stmp140_array[0xF - a1] - stmp140_array[0x7 - a1] - stmp140_array[0x8 + a1];
                                    stmp30_array[0x4 + a1] *= table_626af0[a1];
                                }

                                for (int a1 = 0; a1 < 4; a1++)
                                {
                                    stmp30_array[0xC + a1] = stmp140_array[0x7 - a1] - stmp140_array[0x8 + a1];
                                    stmp30_array[0xC + a1] *= table_626ae0[3 - a1];
                                    stmp30_array[0xC + a1] = (stmp140_array[a1] - stmp140_array[0xF - a1]) * table_626ad0[a1] - stmp30_array[0xC + a1];
                                    stmp30_array[0xC + a1] *= table_626af0[a1];
                                }

                                for (int a1 = 0; a1 < 4; a1++)
                                {
                                    stmp30_array[0x8 + a1] = stmp140_array[0x7 - a1] - stmp140_array[0x8 + a1];
                                    stmp30_array[0x8 + a1] *= table_626ae0[3 - a1];
                                    stmp30_array[0x8 + a1] = (stmp140_array[a1] - stmp140_array[0xF - a1]) * table_626ad0[a1] + stmp30_array[0x8 + a1];
                                }

                                locals_array[72] = stmp30_array[0] + stmp30_array[1] + stmp30_array[2] + stmp30_array[3];
                                locals_array[72] *= 0.5f;

                                int calc_n = 0;
                                calc_buf_array[++calc_n] = stmp30_array[0] - stmp30_array[1] - stmp30_array[2] + stmp30_array[3];
                                calc_buf_array[calc_n] *= 0.7071068f;
                                calc_buf_array[++calc_n] = stmp30_array[0] - stmp30_array[3];
                                calc_buf_array[calc_n] *= 1.847759f;
                                calc_buf_array[++calc_n] = stmp30_array[1] - stmp30_array[2];
                                calc_buf_array[calc_n] *= 0.7653669f;
                                calc_buf_array[++calc_n] = 0.2071068f;
                                calc_buf_array[calc_n] *= calc_buf_array[calc_n - 2];
                                calc_buf_array[++calc_n] = 1.207107f;
                                calc_buf_array[calc_n] *= calc_buf_array[calc_n - 2];
                                calc_buf_array[calc_n - 1] -= calc_buf_array[calc_n];
                                calc_n--;
                                locals_array[20] = calc_buf_array[calc_n--];
                                calc_buf_array[++calc_n] = stmp30_array[4] - stmp30_array[7];
                                calc_buf_array[calc_n] *= 1.847759f;
                                calc_buf_array[++calc_n] = stmp30_array[5] - stmp30_array[6];
                                calc_buf_array[calc_n] *= 0.7653669f;
                                locals_array[30] = stmp30_array[4] + stmp30_array[5] + stmp30_array[6] + stmp30_array[7];
                                locals_array[30] *= 0.5f;
                                locals_array[26] = calc_buf_array[calc_n] + calc_buf_array[calc_n - 1];
                                locals_array[26] *= 0.5f;
                                locals_array[26] -= locals_array[30];
                                locals_array[22] = stmp30_array[4] - stmp30_array[5] - stmp30_array[6] + stmp30_array[7];
                                locals_array[22] *= 0.7071068f;
                                locals_array[22] -= locals_array[26];
                                calc_buf_array[calc_n] = calc_buf_array[calc_n - 1] * 0.2071068f - calc_buf_array[calc_n] * 1.207107f;
                                calc_buf_array[calc_n] -= locals_array[22];
                                locals_array[18] = calc_buf_array[calc_n--];
                                calc_n--;
                                calc_buf_array[++calc_n] = stmp30_array[8] + stmp30_array[9] + stmp30_array[10] + stmp30_array[11];
                                calc_buf_array[calc_n] *= 0.5f;
                                locals_array[71] = calc_buf_array[calc_n] - locals_array[72];
                                locals_array[70] = locals_array[30] - locals_array[71];
                                locals_array[36] = stmp30_array[8] - stmp30_array[9] - stmp30_array[10] + stmp30_array[11];
                                locals_array[36] *= 0.7071068f;
                                calc_buf_array[++calc_n] = stmp30_array[8] - stmp30_array[11];
                                calc_buf_array[calc_n] *= 1.847759f;
                                calc_buf_array[++calc_n] = stmp30_array[9] - stmp30_array[10];
                                calc_buf_array[calc_n] *= 0.7653669f;
                                calc_buf_array[++calc_n] = 0.2071068f;
                                calc_buf_array[calc_n] *= calc_buf_array[calc_n - 2];
                                calc_buf_array[++calc_n] = 1.207107f;
                                ...
                                calc_buf_array[calc_n - 1] -= calc_buf_array[calc_n];
                                calc_n--;
                                locals_array[34] = calc_buf_array[calc_n--];
                                calc_buf_array[++calc_n] = stmp30_array[12] + stmp30_array[13] + stmp30_array[14] + stmp30_array[15];
                                calc_buf_array[calc_n] *= 0.5f;
                                calc_buf_array[calc_n] -= calc_buf_array[calc_n - 3];
                                locals_array[69] = calc_buf_array[calc_n] - locals_array[70];
                                locals_array[27] = (calc_buf_array[calc_n - 1] + calc_buf_array[calc_n - 2]) * 0.5f - calc_buf_array[calc_n];
                                calc_n -= 4;
                                locals_array[68] = (calc_buf_array[calc_n] + calc_buf_array[calc_n - 1]) * 0.5f - locals_array[69];
                                calc_n -= 2;
                                calc_buf_array[++calc_n] = stmp30_array[12] - stmp30_array[15];
                                calc_buf_array[calc_n] *= 1.847759f;
                                locals_array[67] = locals_array[27] - locals_array[68];
                                calc_buf_array[++calc_n] = stmp30_array[13] - stmp30_array[14];
                                calc_buf_array[calc_n] *= 0.7653669f;
                                locals_array[66] = locals_array[26] - locals_array[67];
                                locals_array[37] = calc_buf_array[calc_n] + calc_buf_array[calc_n - 1] - stmp30_array[12] - stmp30_array[13] - stmp30_array[14] - stmp30_array[15];
                                locals_array[37] *= 0.5f;
                                locals_array[35] = stmp30_array[12] - stmp30_array[13] - stmp30_array[14] + stmp30_array[15];
                                locals_array[35] *= 0.7071068f;
                                locals_array[35] -= locals_array[37];
                                calc_buf_array[calc_n - 1] *= 0.2071068f;
                                calc_buf_array[calc_n] *= 1.207107f;
                                calc_buf_array[calc_n - 1] -= calc_buf_array[calc_n];
                                calc_n--;
                                calc_buf_array[calc_n] -= locals_array[35];
                                calc_buf_array[++calc_n] = locals_array[37] - locals_array[27];
                                locals_array[65] = calc_buf_array[calc_n] - locals_array[66];
                                calc_buf_array[calc_n + 1] = calc_buf_array[calc_n];
                                calc_buf_array[calc_n] = calc_buf_array[calc_n - 2];
                                calc_buf_array[calc_n - 2] = calc_buf_array[calc_n + 1];
                                locals_array[64] = calc_buf_array[calc_n] - locals_array[65];
                                calc_n--;
                                calc_buf_array[calc_n - 1] = locals_array[36] - calc_buf_array[calc_n - 1];
                                locals_array[63] = calc_buf_array[calc_n - 1] - locals_array[64];
                                locals_array[62] = locals_array[22] - locals_array[63];
                                calc_buf_array[calc_n - 1] = locals_array[35] - calc_buf_array[calc_n - 1];
                                locals_array[61] = calc_buf_array[calc_n - 1] - locals_array[62];
                                locals_array[60] = locals_array[20] - locals_array[61];
                                calc_buf_array[calc_n - 1] = locals_array[34] - calc_buf_array[calc_n - 1];
                                locals_array[59] = calc_buf_array[calc_n - 1] - locals_array[60];
                                locals_array[58] = locals_array[18] - locals_array[59];
                                calc_buf_array[calc_n] -= calc_buf_array[calc_n - 1];
                                locals_array[57] = calc_buf_array[calc_n] - locals_array[58];
                                calc_n -= 2;
                                ...
                                {
                                    buf_ctmp1[atmp2 - 0xF + a2] = locals_array[57 + a2];
                                }
                                ...
                                fixed (float* table_6 = Decoder_StaticData.MAPCDSD_table_static_6)
            ...
            {
                DecoderChnACCData ad0 = chn_info[a0].acc_data_now;
                chn_info[a0].acc_data_now = chn_info[a0].acc_data_old;
                chn_info[a0].acc_data_old = ad0;

                DecoderChnACCTable at0 = chn_info[a0].acc_table_now;
