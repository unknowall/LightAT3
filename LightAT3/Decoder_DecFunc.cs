namespace LightAT3
{
    public sealed unsafe partial class Decoder
    {
        ...
        static int makeSL128(DecoderChnAccTableTable acc, float* lo, int num0, int num1, int acc_4,
            int acc_360, int chn)
        {
...
#pragma warning restore CS8600
                                    ...
                                    == 0)
                                {
                                    ...
                                    {
                                        table_shita =
                                            Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x000);
                                    }
                                    else
                                    {
                                        table_shita =
                                            Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x100);
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        table_shita =
                                            Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x200);
                                    }
                                    else
                                    {
                                        table_shita =
                                            Decoder_StaticData.MAPCDSD_table_static_1.GetPointer(0x300);
                                    }
                                }
                                    ...
                                    for (uint a1 = 0; a1 < 0x40; a1++)
                                    {
                                        if ((a0 & 1) != 0)
                                        {
                                            stmp40[a1 * 2] =
                                                ...
                                                Decoder_StaticData.MAPCDSD_table_sin0[a1]
                                                + mdata0_table[a00][0x80 * a0 + 0x80 - a1 * 2 - 1] *
                                                Decoder_StaticData.MAPCDSD_table_cos0[a1];
                                            stmp40[a1 * 2 + 1] =
                                                mdata0_table[a00][0x80 * a0 + 0x80 - a1 * 2 - 1] *
                                                Decoder_StaticData.MAPCDSD_table_sin0[a1]
                                                - mdata0_table[a00][0x80 * a0 + a1 * 2] *
                                        ...
                                        for (uint a3 = 0; a3 < 1 << (int)a2; a3++)
                                        {
                                            ...
                                            for (uint a1 = 0; a1 < 0x20 >> (int)a2; a1++)
                                            {
                                                ...
                                                stmp40[base1 + a1 * 2 + base0] =
                                                    ftmp2 * Decoder_StaticData.MAPCDSD_table_sin1[
                                                        a2 * 0x20 + a1]
                                                    + ftmp1 * Decoder_StaticData.MAPCDSD_table_cos1[
                                                        a2 * 0x20 + a1];
                                                stmp40[base1 + a1 * 2 + 1 + base0] =
                                                    ftmp1 * Decoder_StaticData.MAPCDSD_table_sin1[
                                                        a2 * 0x20 + a1]
                                                    - ftmp2 * Decoder_StaticData.MAPCDSD_table_cos1[
                                                        a2 * 0x20 + a1];
                                            }
                                        }
                                    }
                                        ...
                                        for (int a1 = 0x3f; a1 >= 0; a1--)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (l63[a1] < itmp1)
                                                {
                                                    ...
                                                    l256[dtmp1--] =
                                                        l64 * Decoder_StaticData.MAPCDSD_table_static_2[
                                                            itmp2];
                                                    l256[dtmp1--] =
                                                        l64 * Decoder_StaticData.MAPCDSD_table_static_2[
                                                            itmp2 + 1];
            ...
            {
                DecoderChnAccData ad0 = _chnInfo[a0].AccDataNow;
                _chnInfo[a0].AccDataNow = _chnInfo[a0].AccDataOld;
                _chnInfo[a0].AccDataOld = ad0;

                DecoderChnAccTable at0 = _chnInfo[a0].AccTableNow;
